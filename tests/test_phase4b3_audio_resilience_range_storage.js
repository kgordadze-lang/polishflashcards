...
// =========================================================================
eq('R0 the shell cache is the current shell revision', SHELL, 'popolsku-v63');
...
eq('W5 APP_VERSION is the 8.8 release', (INDEX.match(/APP_VERSION\s*=\s*"([^"]+)"/) || [])[1], '8.8');
eq('W5 the shell cache is the current shell revision',
   (SW_SRC.match(/const CACHE\s*=\s*"([^"]+)"/) || [])[1], 'popolsku-v63');
