...
// =========================================================================
eq('R0 the shell cache is the current shell revision', SHELL, 'popolsku-v62');
...
eq('W5 APP_VERSION is the 8.7 release', (INDEX.match(/APP_VERSION\s*=\s*"([^"]+)"/) || [])[1], '8.7');
eq('W5 the shell cache is the current shell revision',
   (SW_SRC.match(/const CACHE\s*=\s*"([^"]+)"/) || [])[1], 'popolsku-v62');
