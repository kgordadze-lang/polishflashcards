...
eq('A4 no new activity screen was added',
   [countOf(INDEX, '<section class="screen"'), countOf(INDEX, 'id="patterns"') > 0,
    countOf(INDEX, 'id="grammar"') > 0], [11, true, true]);
...
// Priority 7 Phase 4F-I1 release, 8.11, and is pinned at that exact value.
eq('J3 no storage key or schema version moved, and the version is the release',
   [countOf(INDEX, 'popolsku-progress-v2'), countOf(INDEX, 'schemaVersion'),
    countOf(INDEX, 'APP_VERSION="8.11"') + countOf(INDEX, "APP_VERSION='8.11'") +
    countOf(INDEX, 'APP_VERSION = "8.11"'),
    countOf(INDEX, 'APP_VERSION = "8.10"')],
   [countOf(INDEX, 'popolsku-progress-v2'), countOf(INDEX, 'schemaVersion'), 1, 0]);
