...
eq('A1 shell cache revision is popolsku-v64',SHELL,'popolsku-v64');
...
eq('D1 APP_VERSION is the 8.9 release',(INDEX.match(/APP_VERSION\s*=\s*"([^"]+)"/)||[])[1],'8.9');
eq('D1 shell cache is v61',(SW_SRC.match(/const CACHE\s*=\s*"([^"]+)"/)||[])[1],'popolsku-v64');
