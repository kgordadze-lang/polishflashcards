...
eq('A1 shell cache revision is popolsku-v60',SHELL,'popolsku-v60');
...
eq('D1 APP_VERSION is the 8.5 release',(INDEX.match(/APP_VERSION\s*=\s*"([^"]+)"/)||[])[1],'8.5');
eq('D1 shell cache is v60',(SW_SRC.match(/const CACHE\s*=\s*"([^"]+)"/)||[])[1],'popolsku-v60');
