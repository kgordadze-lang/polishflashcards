 ...
 * about that.
 *
 * 3,621 clips is today's complete library (verify_audio.py), so the ceiling
 * leaves 579 entries of headroom (about 16%) before anything is ever evicted: a
 ...
 * ------------------------------------------------------------------ */
const AUDIO_CACHE_MAX_ENTRIES = 4200;   /* ceiling: today's 3,621 clips + 579 entries (~16%) headroom */
